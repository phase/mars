define void @Accumulator_init(%Accumulator.2*, i32) {
entry:
  %a = getelementptr inbounds %Accumulator.2, %Accumulator.2* %0, i64 0, i32 0
...
entry:
  ...
  %acc1 = load %Accumulator.2*, %Accumulator.2** %acc, align 8
  %"acc.a = 0" = getelementptr inbounds %Accumulator.2, %Accumulator.2* %acc1, i64 0, i32 0
...
entry:
  %acc = getelementptr inbounds %CPU, %CPU* %0, i64 0, i32 0
  %acc1 = load %Accumulator.2*, %Accumulator.2** %acc, align 8
  %acc4 = getelementptr inbounds %Accumulator.2, %Accumulator.2* %acc1, i64 0, i32 0
...
entry:
  %acc = getelementptr inbounds %CPU, %CPU* %0, i64 0, i32 0
  %acc1 = load %Accumulator.2*, %Accumulator.2** %acc, align 8
  %acc2 = getelementptr inbounds %Accumulator.2, %Accumulator.2* %acc1, i64 0, i32 0
...
entry:
  ...
  %castToAccumulator = bitcast i8* %"malloc(4) for Accumulator" to %Accumulator.2*
  %a = bitcast i8* %"malloc(4) for Accumulator" to i32*
  store i32 0, i32* %a, align 4
  call void @Accumulator_init(%Accumulator.2* %castToAccumulator, i32 1)
  ...
  %castToAccumulator2 = bitcast i8* %"malloc(4) for Accumulator1" to %Accumulator.2*
  %a3 = bitcast i8* %"malloc(4) for Accumulator1" to i32*
  store i32 0, i32* %a3, align 4
  call void @Accumulator_init(%Accumulator.2* %castToAccumulator2, i32 2)
  %1 = bitcast i8* %otherAcc to i8**
  store i8* %"malloc(4) for Accumulator1", i8** %1, align 8
  call void @CPU_ia(%CPU* %castToCPU)
  call void @CPU_ia(%CPU* %castToCPU)
  %cpu = bitcast i8* %"malloc(8) for CPU" to %Accumulator.2**
  %cpu.acc = load %Accumulator.2*, %Accumulator.2** %cpu, align 8
  %cpu.acc6 = getelementptr inbounds %Accumulator.2, %Accumulator.2* %cpu.acc, i64 0, i32 0
